...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#120D0A] text-gray-900 dark:text-gray-100 selection:bg-orange-500 selection:text-white overflow-x-hidden antialiased relative z-0 transition-colors duration-500">
      ...
      <section className="relative w-full max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <Link href="/menu" className="block relative h-[320px] sm:h-[450px] md:h-[550px] rounded-[3rem] overflow-hidden transform-gpu shadow-[0_20px_50px_-12px_rgba(0,0,0,0.3)] bg-[#0a0a0a] ring-1 ring-black/5 dark:ring-orange-500/30 group cursor-pointer">
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-2.5 z-20 bg-white/10 dark:bg-black/30 backdrop-blur-xl px-5 py-3 rounded-2xl border border-white/20 dark:border-orange-500/20 shadow-xl" onClick={(e) => e.stopPropagation()}>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 text-center">
        ...
        <p className="text-gray-500 dark:text-orange-200/70 text-sm sm:text-base mt-4 font-medium tracking-wide max-w-xl mx-auto">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 pt-4">
        <div className="relative flex flex-col md:flex-row items-center justify-center min-h-[420px] gap-8 md:gap-0">
          ...
          <Link href="/menu" className="w-full sm:w-72 md:w-80 md:absolute md:left-4 lg:left-10 z-10 transform md:-rotate-6 md:translate-y-4 hover:z-30 hover:-translate-y-4 hover:rotate-0 transition-all duration-500 bg-white dark:bg-[#1c1410]/70 dark:backdrop-blur-xl rounded-[2.5rem] overflow-hidden transform-gpu shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_-10px_rgba(234,88,12,0.15)] hover:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.2)] ring-1 ring-gray-900/5 dark:ring-orange-500/20 group block cursor-pointer">
            <div className="h-72 sm:h-80 bg-gray-50 dark:bg-[#18110e] relative overflow-hidden rounded-[2.5rem]">
          ...
          <Link href="/menu" className="w-full sm:w-80 md:w-96 md:absolute z-20 transform hover:-translate-y-6 transition-all duration-500 bg-white dark:bg-[#1c1410]/80 dark:backdrop-blur-xl rounded-[3rem] overflow-hidden transform-gpu shadow-[0_20px_60px_-15px_rgba(249,115,22,0.3)] hover:shadow-[0_30px_70px_-15px_rgba(249,115,22,0.4)] ring-2 ring-orange-500/50 group block cursor-pointer">
            <div className="h-80 sm:h-96 bg-gray-50 dark:bg-[#18110e] relative overflow-hidden rounded-[3rem]">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16 text-center">
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-black uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-gray-800 to-gray-500 dark:from-white dark:via-orange-100 dark:to-orange-300">
          Our Signature Menu
        </h2>
          ...
          {[8, 9, 10, 11, 12, 13, 14, 15, 16].map((num, idx) => (
            <Link key={num} href="/menu" className="flex flex-col group cursor-pointer">
              <div className="w-full bg-white dark:bg-[#1c1410]/70 dark:backdrop-blur-xl rounded-[2.5rem] p-2 overflow-hidden transform-gpu shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_10px_30px_rgba(234,88,12,0.1)] hover:shadow-[0_20px_50px_rgb(0,0,0,0.12)] hover:-translate-y-2 transition-all duration-500 ring-1 ring-gray-100 dark:ring-orange-500/20">
                <div className="h-60 sm:h-64 rounded-[2rem] bg-gray-50 dark:bg-[#18110e] overflow-hidden transform-gpu relative">
              ...
              <div className="mt-5 flex items-center justify-between px-2">
                <h3 className="text-xl font-black uppercase tracking-widest text-gray-800 dark:text-orange-100 group-hover:text-orange-600 transition-colors duration-300">
                  {menuCategories[idx]}
                </h3>
      ...
      {/* 6. JUMBO DEAL BANNER */}
      <section className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pb-28">
        <div className="bg-gradient-to-br from-[#1c1410] via-[#120D0A] to-[#1a120e] dark:border dark:border-orange-500/30 rounded-[3rem] p-8 sm:p-12 md:p-16 text-white shadow-[0_20px_50px_-10px_rgba(234,88,12,0.2)] flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden group">
          ...
          <div className="space-y-8 text-center md:text-left z-10 max-w-xl">
            ...
            <div className="space-y-4">
              <h3 className="text-4xl sm:text-5xl md:text-6xl font-black uppercase tracking-tighter leading-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-orange-200">JUMBO DEAL <br/> <span className="text-orange-500">ORDER NOW!</span></h3>
              <p className="text-base sm:text-lg font-medium text-orange-100/70 max-w-md">
          ...
          <Link href="/menu" className="z-10 transform md:rotate-3 hover:rotate-0 hover:scale-105 transition-all duration-500 flex-shrink-0 cursor-pointer relative">
            ...
            <div className="w-64 sm:w-72 md:w-80 lg:w-[400px] h-60 sm:h-72 lg:h-80 rounded-[2.5rem] overflow-hidden transform-gpu shadow-2xl border border-orange-500/30 bg-[#120D0A] relative">
      ...
      <section className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pb-28">
        <div className="flex flex-col items-center mb-14">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-gray-800 to-gray-500 dark:from-white dark:via-orange-100 dark:to-orange-300">Taste The Action</h2>
      ...
      <section className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pb-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          {/* Newsletter Box */}
          <div className="bg-[#18110e] dark:border dark:border-orange-500/30 text-white rounded-[3rem] p-8 sm:p-12 shadow-[0_20px_50px_-10px_rgba(234,88,12,0.15)] flex flex-col justify-center gap-8 relative overflow-hidden">
            <div className="absolute -top-24 -right-24 w-64 h-64 bg-orange-600/30 rounded-full blur-[80px]"></div>
            <div className="relative z-10">
              <h3 className="text-3xl sm:text-4xl font-black uppercase tracking-tighter mb-4 text-transparent bg-clip-text bg-gradient-to-r from-white to-orange-200">Get Delicious Alerts</h3>
              <p className="text-sm sm:text-base text-orange-100/70 font-medium max-w-md">Subscribe to get special discount codes and secret menu drops directly in your inbox.</p>
            </div>
          ...
          {/* Social Box */}
          <div className="bg-white dark:bg-[#18110e] dark:border dark:border-orange-500/30 text-gray-900 dark:text-gray-100 rounded-[3rem] p-8 sm:p-12 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.08)] flex flex-col justify-center gap-8 relative overflow-hidden">
            <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-orange-500/10 rounded-full blur-[80px]"></div>
            <div className="relative z-10">
              <h3 className="text-3xl sm:text-4xl font-black uppercase tracking-tighter mb-4 text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-500 dark:from-white dark:to-orange-200">Follow The Vibe</h3>
              <p className="text-sm sm:text-base text-gray-500 dark:text-orange-100/70 font-medium max-w-md">Join our community across all platforms for daily cravings and food drops.</p>
            </div>
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 relative z-10">
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-16 h-16 bg-gray-50 dark:bg-[#120D0A] dark:border dark:border-orange-500/20 rounded-[1.25rem] flex items-center justify-center shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-[#1877F2]">
              ...
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-16 h-16 bg-gray-50 dark:bg-[#120D0A] dark:border dark:border-orange-500/20 rounded-[1.25rem] flex items-center justify-center shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-[#E4405F]">
              ...
              <a href="https://snapchat.com" target="_blank" rel="noreferrer" className="w-16 h-16 bg-[#FFFC00] rounded-[1.25rem] flex items-center justify-center shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-black">
              ...
              <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="w-16 h-16 bg-gray-50 dark:bg-[#120D0A] dark:border dark:border-orange-500/20 rounded-[1.25rem] flex items-center justify-center shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-black dark:text-white">
